...
public class SportsCar extends Vehicle implements Automobile {
    ...
    SportsCar(Boolean engineState, int speed, int gear){
        this.engineState = engineState;
        this.speed = speed;
        this.gear = gear;
    }

    SportsCar(Boolean engineState){
        this.engineState = engineState;
        this.speed = 0;
        this.gear = 1;
    }
    ...
    public void changeGear(int newGear){ 
        ...
        System.out.println((newGear > 0 && newGear<7) ? "The gear has changed to "+ newGear : "The gear has not changed");
    } 
